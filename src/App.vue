      ...
      <div class="hero-body">
        <div class="container">
          <div class="th-logo has-text-centered">
            <img src="https://cdn.treehouseinternetgroup.com/cms_images/2992/Atl-Basement-Systems_Vert_RGB.svg" alt="" style="width:275px">
          </div>
    ...
    <footer class="" id="footer">
        <div class="container">
            <div class="content has-text-centered">
                <p>
                    &copy;2021 Atlanta Basement Systems
                </p>
            </div>
        </div>
    </footer>
